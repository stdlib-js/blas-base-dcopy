...
```javascript
import dcopy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dcopy@v0.3.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-base-dcopy/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/blas-base-dcopy/actions/workflows/test.yml?query=branch:v0.3.0
